...
# 读入数据
data = pd.read_excel(r"C:\Users\14684\Desktop\stirpat\农业.xlsx")
...
POP_GROWTH_STEP = -0.00005
GDP_GROWTH_INIT = 0.062
GDP_GROWTH_STEP = -0.00075
...
def predict_next_year_data(population, gdp_per_capita, urbanization_rate,m_d,n_d,IS,EI,ES):
    ...
    if URBANIZATION_GROWTH_INIT>0.01:
...
if __name__ == '__main__':
    # 初始化初始数据
    initial_population = 1214.43
    initial_gdp_per_capita = 1.47
